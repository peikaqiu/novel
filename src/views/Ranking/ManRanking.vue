<template>
  <div class="ranking" ref="rankingLoop">
    <div class="rankingContent">
      ...
      <div class="title" v-for="(item,index) in getRankings.male">
...
<script>
  ...
  export default{
    ...
    methods: {
      ...
      ...mapActions(['getInformation','getFemaleRanking','getZiRanking']),
      back(){
      ...
      setTofemale(){
        this.$router.push({path: '/FemaleRanking'})
        this.getFemaleRanking({axios:this.axios})
          .then(() => {
